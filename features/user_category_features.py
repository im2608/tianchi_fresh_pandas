...
def feature_user_category_opt_before1day(slide_window_df, UIC, behavior_type, feature_matrix_df):

    opt_before1day_df = feature_user_opt_before1day(slide_window_df, UIC, behavior_type, 'item_category')
    if (behavior_type == 2):
